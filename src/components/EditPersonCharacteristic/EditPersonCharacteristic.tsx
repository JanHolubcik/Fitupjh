import { Modal, ModalContent, ModalHeader, ModalBody, Button, Input, Avatar, useDisclosure } from "@nextui-org/react";
...
const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    handleManualSubmit(data.weight,data.height,"lose weight",selectedAvatar || "pfps/3.png",data.email,data.userName)
                  ...
                  <form className="flex flex-col gap-4 mt-5" onSubmit={handleSubmit}>
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        type="number"
                        placeholder="Weight"
                        defaultValue={props.initialValues.weight?.toString()||""}
                        required
                      />
                    </div>
                    <div>
                      ...
                      <Input
                        ...
                        type="number"
                        placeholder="Height"
                         defaultValue={props.initialValues.height?.toString()||""}
                        required
                      />
                    </div>
